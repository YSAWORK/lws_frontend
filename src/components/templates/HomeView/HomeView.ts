...
type Profile = Record<string, unknown> // заміни на свій інтерфейс

export function HomeView(idFromProp?: string | number) {
    ...
    async function fetchProfile(id?: string | number) {
        try {
            ...
            // ВАЖЛИВО: використовуємо api, щоб підставлявся Authorization
